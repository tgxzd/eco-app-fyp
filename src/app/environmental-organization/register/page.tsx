    ...
    <div className="relative min-h-screen bg-[#121212] flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-md px-6 py-12 bg-black/50 backdrop-blur-sm rounded-lg shadow-xl border border-amber-700/30">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-amber-100 mb-2">Organization Registration</h1>
          <div className="w-16 h-1 mx-auto bg-amber-700"></div>
        </div>

        <form action={handleSubmit} className="space-y-6">
          <div>
            <label htmlFor="organizationName" className="block text-sm font-medium text-amber-100 mb-2">
              Organization Name
            </label>
            <input
              id="organizationName"
          ...
          <div>
            <label htmlFor="phoneNumber" className="block text-sm font-medium text-amber-100 mb-2">
              Phone Number
            </label>
            <input
              id="phoneNumber"
